...
import time
from postgres_cfg import postgres_toggle, create_kaiten_times_table, create_data_kaiten_table, update_comments_in_table
...
try:
    ...
    with connection.cursor() as cursor:
        ...
        create_kaiten_times_table(kaiten_times_table_name, kaiten_times_json_path)
        ...
        add_comment(cards_data, api_key, kaiten_times_table_name)
        
        update_comments_in_table(kaiten_data_tabble_name, comments_json_path)
